...
class MdaoZ(unittest.TestCase):
    ...
    def test_oms_allot1(self):
        ...
        dbfksSKu = self.driver.find_element_by_xpath(
            '//*[@id="routes"]/div[2]/div[2]/div/div[2]/div/div/div/section[2]/div[1]/div/div[2]/div[2]/table/tbody/tr/td[12]/div/span').text
        zkucunq = self.driver.find_element_by_xpath('//*[@id="routes"]/div[2]/div[2]/div/div[2]/div/div/div/section[2]/div[1]/div/div[2]/div[2]/table/tbody/tr/td[10]/div/span').text
        homepage.jqpdj()  # 点击配件
        time.sleep(2)
        homepage.jqpfpNumc()
        self.driver.find_element_by_xpath(
            '//*[@id="routes"]/div[2]/div[2]/div/div[2]/div/div/div/section[2]/div[3]/div/div[2]/div[2]/table/tbody/tr/td[9]/div/input').clear()
        self.driver.find_element_by_xpath(
            '//*[@id="routes"]/div[2]/div[2]/div/div[2]/div/div/div/section[2]/div[3]/div/div[2]/div[2]/table/tbody/tr/td[9]/div/input').send_keys(
            '5')  # 输入数量
        ...
        time.sleep(2)
        self.driver.find_element_by_xpath('/html/body/div[9]/div[2]/div/div/div[2]/form/div/div[5]/div/input').send_keys(dbdh)  # 输入申请单号
        ...
        try:
            assert zhanyong == 5
            print("4.受理前配件" + SKU1 + "的锁定库存为" + dbfksSKu, ",受理后配件" + SKU1 + "的锁定库存为" + dbslhkc, '占用库存为:5')
        except Exception as e:
            print('4.库存占用失败！！！'+ SKU1 + "的锁定库存为" + dbfksSKu, ",受理后配件" + SKU1 + "的锁定库存为" + dbslhkc, '占用库存为:5', format(e))
            homepage.get_windows_img()
        ...
        time.sleep(2)
        self.driver.find_element_by_xpath('//*[@id="routes"]/div[2]/div[2]/div/div[2]/div/div/section/div[2]/div[1]/div/div[3]/input').send_keys(SKU1)
    ...
    def test_oms_allot3(self):
        ...
        time.sleep(2)
        self.driver.switch_to.window(window[-0])
        self.driver.find_element_by_xpath('//*[@id="routes"]/div[2]/div[2]/div/div[2]/div/div/div/section[1]/div/div/div[3]/button').click()  # 点击查询
        time.sleep(2)
        cyhkeshouNum = self.driver.find_element_by_xpath(
            '//*[@id="routes"]/div[2]/div[2]/div/div[2]/div/div/div/section[2]/div[1]/div/div[2]/div[2]/table/tbody/tr/td[12]/div/span').text  # 获取锁定数量
        self.driver.find_element_by_xpath('//*[@id="leftInner"]/ul/li[4]/div/div').click()  # 点击调拨管理
        self.driver.find_element_by_xpath('//*[@id="leftInner"]/ul/li[4]/ul/li[1]/div/div').click()  # 点击调拨单
        time.sleep(1)
        self.driver.find_element_by_xpath('//*[@id="leftInner"]/ul/li[4]/ul/li[1]/ul/li[3]/div').click()  # 点击调拨出库
        time.sleep(2)
        a = self.driver.find_element_by_xpath(
            '//*[@id="routes"]/div[2]/div[2]/div/div[2]/div/div/main/div[1]/section[2]/div/div/div/div/div['
            '1]/div/div[2]/div[1]/div[2]/table/tbody/tr[1]/td[2]/div/span').text
        ...
        try:
            ...
            print('2.WMS回传oms成功，确认差异前配件' + SKU1, '的锁定数量为' + keshouNum, '，确认差异后配件' + SKU1, '锁定数量为' + cyhkeshouNum, '差异数量为：1')
        except Exception as e:
            print('2.WMS回传oms失败', format(e))
            homepage.get_windows_img()
